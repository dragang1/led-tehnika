...
import TopCategoryList from '@/app/(site)/(routes)/kategorije/_components/TopCategoryList'
...
export async function generateMetadata({ params }) {
  ...
  try {
    ...
    const categoryList = await CmsApi.getCategoryList()
...
export async function generateStaticParams() {
  try {
    const categories = await CmsApi.getCategoryList()
...
export default async function Page({ params }) {
  ...
  try {
    ...
    categoryList = await CmsApi.getCategoryList()
    ...
    if (actualCategory) {
      products = await CmsApi.getProductsByCategoryName(actualCategory.name)
    }
  } catch (error) {
