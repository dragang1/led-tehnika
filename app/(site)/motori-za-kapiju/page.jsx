...
export async function generateMetadata() {
  ...
  try {
    const stranica = await CmsApi.getStranicaBySlug('motori-za-kapiju')
...
export default async function Page() {
  ...
  // Fetch main product
  const mainProduct = await CmsApi.getProductBySlug('motor-za-kapiju-set')
  ...
  const coverUrl = stranica.cover?.url ? getImageUrl(stranica.cover) : null
