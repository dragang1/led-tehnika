    ...
    <div className="group relative w-full h-full flex flex-col bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border border-gray-200 hover:border-primary/30">
      ...
      <div className="p-4 flex flex-col flex-grow">
        <Link href={productUrl}>
          <h3 className="font-semibold text-sm sm:text-base text-gray-900 mb-2 line-clamp-2 h-[3rem] leading-tight group-hover:text-primary transition-colors cursor-pointer">
            {name}
          </h3>
        </Link>
        ...
        {/* Action Buttons - Separate from Links */}
