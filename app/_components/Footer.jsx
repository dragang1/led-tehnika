            ...
            <div className="relative border-b border-white/10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
                        <div className="group relative bg-white/[0.03] border border-white/10 rounded-xl sm:rounded-2xl p-3 sm:p-5 hover:bg-white/[0.05] hover:border-blue-500/30 transition-all duration-300">
                            <div className="flex flex-col sm:flex-row items-center sm:items-center gap-2 sm:gap-4 text-center sm:text-left">
                                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-500/20 rounded-lg sm:rounded-xl flex items-center justify-center border border-blue-400/30 flex-shrink-0">
                                    <Truck className="w-4 h-4 sm:w-5 sm:h-5 text-blue-300" />
                                </div>
                                <div>
                                    <h4 className="text-white font-semibold text-xs sm:text-sm">Brza dostava</h4>
                                    <p className="text-slate-300 text-[10px] sm:text-xs mt-0.5">Po cijeloj BiH</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="group relative bg-white/[0.03] border border-white/10 rounded-xl sm:rounded-2xl p-3 sm:p-5 hover:bg-white/[0.05] hover:border-blue-500/30 transition-all duration-300">
                            <div className="flex flex-col sm:flex-row items-center sm:items-center gap-2 sm:gap-4 text-center sm:text-left">
                                ...
                                <div>
                                    <h4 className="text-white font-semibold text-xs sm:text-sm">Garancija</h4>
                                    <p className="text-slate-300 text-[10px] sm:text-xs mt-0.5">Na sve proizvode</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="group relative bg-white/[0.03] border border-white/10 rounded-xl sm:rounded-2xl p-3 sm:p-5 hover:bg-white/[0.05] hover:border-blue-500/30 transition-all duration-300">
                            <div className="flex flex-col sm:flex-row items-center sm:items-center gap-2 sm:gap-4 text-center sm:text-left">
                                ...
                                <div>
                                    <h4 className="text-white font-semibold text-xs sm:text-sm">Sigurna kupovina</h4>
                                    <p className="text-slate-300 text-[10px] sm:text-xs mt-0.5">Plaćanje pouzećem</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="group relative bg-white/[0.03] border border-white/10 rounded-xl sm:rounded-2xl p-3 sm:p-5 hover:bg-white/[0.05] hover:border-blue-500/30 transition-all duration-300">
                            <div className="flex flex-col sm:flex-row items-center sm:items-center gap-2 sm:gap-4 text-center sm:text-left">
                                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-500/20 rounded-lg sm:rounded-xl flex items-center justify-center border border-blue-400/30 flex-shrink-0">
                                    <Headphones className="w-4 h-4 sm:w-5 sm:h-5 text-blue-300" />
                                </div>
                                <div>
                                    <h4 className="text-white font-semibold text-xs sm:text-sm">Podrška</h4>
                                    <p className="text-slate-300 text-[10px] sm:text-xs mt-0.5">Stručni savjeti</p>
                                </div>
                            </div>
                        </div>
                    </div>
